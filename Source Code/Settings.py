class Settings:
    def __init__(self, loadTable, num_days, num_teams, max_freq, test_time, first_Date, last_Date,  thusat_adjust, frisun_adjust, academic_days, stat_holidays, combinations_switch, requests_switch, max_two_weekends, academic_switch, weekday_max, max_load_diff, max_consec):
